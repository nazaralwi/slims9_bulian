...
// check dependency
if (!file_exists(SB.'plugins'.DS.'reservasi_ruang_diskusi'.DS.'bs4formmaker.inc.php'))
{
    echo '<div class="bg-danger p-2 text-white">';
    echo 'Folder <b>'.SB.'plugins'.DS.'reservasi_ruang_diskusi'.DS.'bs4formmaker.inc.php</b> tidak ada. Pastikan folder itu tersedia.';
    echo '</div>';
}
else
{
    ...
    // require helper
    require SB.'plugins'.DS.'reservasi_ruang_diskusi'.DS.'bs4formmaker.inc.php';
